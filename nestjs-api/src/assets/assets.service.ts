    ...
    return new Observable((observer) => {
      this.assetSchema
        .watch(
          ...
          {
            fullDocument: 'updateLookup', // forma de procurar infos. nesse caso quer uma copia do documento alterado
            fullDocumentBeforeChange: 'whenAvailable', // versao mais completa. quer a versao anterior tambem
          },
        )
